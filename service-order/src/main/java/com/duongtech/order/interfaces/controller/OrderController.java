package com.duongtech.order.interfaces.controller;

import com.duongtech.order.application.dto.CreateOrderDto;
import com.duongtech.order.application.dto.OrderDto;
import com.duongtech.order.application.dto.OrderItemDto;
import com.duongtech.order.application.usecase.CreateOrderUseCase;
import com.duongtech.order.application.usecase.GetUserOrdersUseCase;
...
import com.duongtech.order.infrastructure.client.InventoryServiceClient;
...
public class OrderController {
    ...
    private final com.duongtech.order.infrastructure.config.RabbitMQConfig rabbitMQConfig;
    ...
    public ResponseEntity<OrderDto> updateOrderStatus(
        ...
        if (oldStatus == OrderStatus.PENDING && newStatus == OrderStatus.CONFIRMED) {
            ...
            rabbitTemplate.convertAndSend(
                com.duongtech.order.infrastructure.config.RabbitMQConfig.EXCHANGE, 
                com.duongtech.order.infrastructure.config.RabbitMQConfig.ORDER_CONFIRMED_ROUTING_KEY, 
                event
            );
