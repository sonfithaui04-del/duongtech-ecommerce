...
-- 6 mặt hàng (chỉ chèn khi bảng ingredients đang rỗng)
INSERT INTO ingredients (name, unit, quantity, min_quantity, cost_per_unit, expiry_date, description, active, created_at, updated_at)
SELECT * FROM (VALUES
