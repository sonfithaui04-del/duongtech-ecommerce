-- =====================================================================
-- DuongTech · service-menu · seed data (auto-loaded by Spring Boot)
-- 5 danh mục + 12 sản phẩm gốc + 100 sản phẩm sinh thêm = 112 menu_items
...
INSERT INTO menu_items (category_id, name, description, price, image_url, available, display_order, average_rating, total_reviews, created_at, updated_at)
