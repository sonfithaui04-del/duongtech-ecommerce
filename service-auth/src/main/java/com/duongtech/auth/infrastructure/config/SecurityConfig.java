...
import com.duongtech.auth.application.service.CustomOAuth2UserService;
import com.duongtech.auth.infrastructure.security.OAuth2AuthenticationSuccessHandler;
...
public class SecurityConfig {
    ...
    private final com.duongtech.auth.infrastructure.security.SecurityErrorFilter securityErrorFilter;
    ...
    public org.springframework.web.cors.CorsConfigurationSource corsConfigurationSource() {
        ...
        configuration.setAllowedOrigins(java.util.Arrays.asList("http://localhost:3001", "http://localhost:3003", "http://localhost:9080"));
